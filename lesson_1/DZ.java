...
//        if(x % 4 == 0) System.out.println("Р“РѕРґ РІРёСЃРѕРєРѕСЃРЅС‹Р№!");
//        else if(x % 400 == 0) System.out.println("Р“РѕРґ РІРёСЃРѕРєРѕСЃРЅС‹Р№!");
//        else if(x % 100 == 0) System.out.println("Р“РѕРґ РЅРµ РІРёСЃРѕРєРѕСЃРЅС‹Р№!");
//        else System.out.println("Р“РѕРґ РЅРµ РІРёСЃРѕРєРѕСЃРЅС‹Р№!");
//    }
//
//
//
...
//
//        float res_count = a * (b + (c / d));
//        System.out.println("a*(b+(c/d))= " + res_count);
//
//        return res_count;
//    }
//
